...
namespace FirstGearGames.Mirrors.Assets.FlexNetworkTransforms.Editors
{
    ...
    public class FlexNetworkTransformBaseEditor : Editor
    {
        ...
        private SerializedProperty _accelerateEasing;
        private SerializedProperty _decelerateEasing;
        ...
        protected virtual void OnEnable()
        {
            ...
            _accelerateEasing = serializedObject.FindProperty("_accelerateEasing");
            _decelerateEasing = serializedObject.FindProperty("_decelerateEasing");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_accelerateEasing, new GUIContent("Accelerate Easing", "Percentage of new movement rates to use when transform is speeding up. Higher values will cause the transform to achieve the higher speed faster. Use lower values if you would prefer a more gradual increase over speed changes. Default value is 1f."));
            EditorGUILayout.PropertyField(_decelerateEasing, new GUIContent("Decelerate Easing", "Percentage of new movement rates to use when transform is slowing down. Higher values will cause the transform to slow down more rapidly. When using faster synchronization intervals, such as fixed update, this is generally best left close to 1f. When using longer synchronization intervals, such as 100ms, values closer to 0.2f may show better results. Default value is 1f."));
